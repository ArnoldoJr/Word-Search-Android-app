...
/**
 * Comments by Arnoldo Rodriguez:
 *
 * FEATURES:
 * 1. Swipe to select
 * 2. Click on "New Game" to randomly rearrange the letters in the grid
 * 3. Green check mark and red x when you find or do not find a word.
 * 4. "Good" look
 *
 * LIMITATIONS:
 * 1. Swiping is limited to horizontal and vertical axis only.
 * 2. Made it portrait only.
 */
